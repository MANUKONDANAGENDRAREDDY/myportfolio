...
export default function Page() {
  ...
  const skillsData: SkillItem[] = [
    { name: "HTML", image: "/images/html-5-svgrepo-com.svg" },
    { name: "CSS", image: "/images/css-svgrepo-com.svg" },
    { name: "JavaScript", image: "/images/js-svgrepo-com.svg" },
    {
      name: "React",
      image: "/images/react-javascript-js-framework-facebook-svgrepo-com.svg",
    },
    // { name: "Next.js", image: "/images/icons8-nextjs-48.png" },
    // { name: "Material UI", image: "/images/material-ui-svgrepo-com.svg" },
    // { name: "Tailwind CSS", image: "/images/tailwind-svgrepo-com.svg" },
  ];
  ...
  const projectsData: ProjectItem[] = [
    ...
    },
    {
      ...
      title: "vivantahotels",
      description: "Developed a responsive hotel booking website for a client",
      link: "https://www.vivantahotels.com/en-in",
    },
    {
      image: "/images/developer.jpg",
      title: "seleqtionshotels",
      description:
        "Built a modern hotel booking website with Material UI and Next.js",
      link: "https://www.seleqtionshotels.com/en-in",
    },
  ];
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      alt: "github",
      image: "/images/icons8-github-50.png",
    },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-xl reveal-left">
              ...
              expertise to develop high-quality software solutions.
            </p>
              ...
              {socialLinks.map((social, index) => (
                ...
                >
                  <Image
                    ...
                    height={50}
                    className={`size-12 ${
                      social.alt === "twitter" || social.alt === "github"
                        ? "bg-white rounded-md"
                        : ""
                    }`}
                  />
          ...
          <div className="hidden md:block reveal-top">
            <Image
              ...
              width={400}
              height={300}
              className="w-8rem h-1rem object-contain rounded-full mx-auto bg-gray-50 dark:bg-black dark:brightness-75 brightness-100 shadow-[0px_9px_12px_rgba(255,0,134,0.815),0px_6px_12px_rgba(245,121,5,0.83),6px_0px_15px_rgb(5,247,247)]"
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 reveal-left">
            {servicesData.map((service, index) => (
              <div
                key={index}
                className="relative bg-white p-6 rounded-lg overflow-hidden shadow-lg hover:transform hover:-translate-y-2 transition-all duration-300 hover:shadow-[0px_4px_6px_rgba(255,0,234,0.815),0px_6px_12px_rgba(255,72,0,0.83),6px_0px_15px_rgb(5,247,247)]"
              >
                ...
                />
                <div className="absolute inset-0 bg-white flex flex-col justify-center items-center p-6 opacity-0 transition-opacity duration-500 hover:opacity-100">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {skillsData.map((skill, index) => (
              <div
                key={index}
                className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-colors hover:transform hover:-translate-y-2 duration-300 hover:shadow-green-600 reveal-left"
              >
                <Image
                  src={skill.image}
                  alt={skill.name}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 lg:mt-8 gap-8">
            {projectsData.map((project, index) => (
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-white bg-opacity-50 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="reveal-left">
                ...
                <input
                  ...
                  onInput={handleInput}
                  required
                  className="w-full p-3 rounded-lg bg-gray-100 dark:text-black focus:outline-none focus:ring-2 focus:ring-blue-400"
                />
                {errors.fullName && (
